...
const keyInfo = {
	"splatoon3_random": {"page": "Splatoon 3 - Randomizer", "desc": "Contains all randomizer settings, including which stages and weapons can be selected."},
	...
	"splatoon2_random": {"page": "Splatoon 2 - Randomizer", "desc": "Contains all randomizer settings, including which stages and weapons can be selected."},
	...
	"splatoon_random": {"page": "Splatoon - Randomizer", "desc": "Contains all randomizer settings, including which stages and weapons can be selected."},
	...
	"gridmaster": {"page": "OSRS - Gridmaster"},
	"gridmaster_settings": {"page": "OSRS - Gridmaster"},
	"nkOSRS_leagues3": {"page": "OSRS - Leagues 3: Shattered Relics"},
	"osrs_highscores_sort": {"page": "OSRS - Highscores sorter"},
	
	"timestamps_autocopy": {"page": "Timestamps tool"}
};
const renameKeys = {
	// "from":"to"
