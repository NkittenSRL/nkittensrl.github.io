...
function weaponBox(wpn) {
	...
	txt += "<div class='DepletionContainer'><span class='depletionTxt'>Special Cost:</span> <span class='depletion'>" + ((wpn.specialcost === "" || wpn.specialcost === undefined) ? "Unknown" : wpn.specialcost + "p") + "</span></div>";
	txt += "</div>";
	return txt;
}
