...
{ name: "Bianco 4 Fluddless", jp: "ビアンコ4ポンプ禁止", types: ["Bianco_20", "Bianco_Early", "Bianco_Shines"] },
...
{ name: "Ricco 6 Using Pink Blooper", jp: "リコ6を紫イカでクリア", types: ["Ricco_Top", "Ricco_Early", "Ricco_6", "Ricco_100", "Ricco_Shines"] }
];
bingoList[11] = [
...
bingoList[16] = [
{ name: "Defeat all 3 Gooper Blooper Bosses", jp: "ボスゲッソーを3体倒す", types: ["Noki_Early", "XBoss_Shines", "Ricco_6", "Ricco_Shadow"] },
...
bingoList[21] = [
{ name: "Defeat King Boo", jp: "ボステレサ撃破", types: ["Sirena_5", "Sirena_Late", "Sirena_8", "Sirena_Boss"] },
...
{ name: "Ride Yoshi in 3 Different Levels (not plaza)", jp: "ドルピックタウン以外の3つのステージでヨッシーに乗る", types: ["Pianta_6", "Pianta_Yoshi", "Butterfly", "X_Lives", "Plaza_Shines", "5_Bosses"] },
...
{ name: "Collect Two Episode 8 Shines", jp: "トーリー8のシャインを2枚取得", types: ["2EP_8", "Shadow_Mario"] },
