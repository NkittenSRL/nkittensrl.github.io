var thisVersion = "v3 beta 1";

var bingoList = [];
bingoList[1] = [
{ name: "10 Blue Coins from Delfino Plaza", types: ["Plaza_Blues", "Plaza_M", "Fruit_Ladies"] },
{ name: "15 Blue Coins from Pianta Village", types: ["Pianta_Blues", "Goopy_Inferno", "Pianta_30"] },
{ name: "Three blue coins from fruit ladies", types: ["Fruit_Ladies"] },
{ name: "15 Blue Coins from Ricco Harbor", types: ["Ricco_Blues", "Ricco_M", "Ricco_30"] }
];
bingoList[2] = [
{ name: "Collect Ricco 3 Shine from the top", types: ["Ricco_Top", "Ricco_Early", "Ricco_20", "Ricco_Rocket"] },
{ name: "5 Linked Blue Coin Pairs", types: ["Linked_Blues"] },
{ name: "Clear a Gelato Beach Episode of all Cataquacks", types: ["Gelato_Quacks", "Gelato_Early", "Wiggler"] },
...
{ name: "Complete Episode 4 of Bianco Hills Entirely Fluddless", types: ["Bianco_20", "Bianco_Early"] }
];
bingoList[3] = [
{ name: "10 Blue Coins from Pinna Park", types: ["Pinna_Blues", "Pinna_Early", "Pinna_Boss", "Pinna_30"] },
...
{ name: "Complete Episode 2 of Ricco Harbor Entirely Blooperless", types: ["Ricco_Top", "Ricco_Hidden", "Ricco_Early", "Ricco_Rocket"] },
{ name: "Collect 2 Hidden Shines in Gelato Beach", types: ["Gelato_Early", "Gelato_Hidden", "Gelato_Quacks"] },
{ name: "Collect 1 Hidden Shine in Bianco Hills", types: ["Bianco_Early", "Bianco_Hidden"] }
];
bingoList[4] = [
{ name: "All (four) fruit lady blue coins", types: ["Fruit_Ladies"] },
{ name: "15 Blue Coins from Gelato Beach", types: ["Gelato_Blues", "Gelato_Quacks", "Gelato_30"] },
{ name: "Goopy Inferno (Pianta 3) NO damage taken", types: ["Goopy_Inferno", "Paint_Race"] },
{ name: "20 Blue Coins from Ricco Harbor", types: ["Ricco_Blues", "Ricco_M", "Ricco_Early", "30"] },
{ name: "4 Shines from Bianco Hills", types: ["Bianco_Rocket", "Bianco_Boss", "Bianco_Secret", "Bianco_Hidden", "Bianco_Early", "Bianco_Late", "Bianco_Blues"] },
{ name: "Collect 1 Hidden Shine in Ricco Harbor", types: ["Ricco_Top", "Ricco_Hidden", "Ricco_Early", "Ricco_Rocket"] }
];
bingoList[5] = [
{ name: "20 Blue Coins from Gelato Beach", types: ["Gelato_20", "Gelato_Early", "Gelato_Blues", "Gelato_100s", "Wiggler", "Gelato_30"] },
...
{ name: "Defeat Petey Strikes Back (Bianco 5)", types: ["Bianco_Boss", "Bianco_Early", "Unique_Boss", "XBoss_Shines"] },
{ name: "100 Coin Shine from Sirena Beach", types: ["Sirena_100s", "X100_Coins", "Sirena_Early"] },
{ name: "15 Blue Coins from Delfino Plaza", types: ["XBlue_Coins", "Ricco_Blues", "Gelato_Blues", "Bianco_Blues", "Pinna_Blues", "Pianta_Blues", "Sirena_Blues", "Noki_Blues"] },
{ name: "100 Coin Shine from Ricco Harbor", types: ["Ricco_100s", "Ricco_Early", "Ricco_Top", "Ricco_Rocket"] }
];
bingoList[6] = [
{ name: "6 Blue Bird Blue Coins", types: ["Blue_Bird", "Gelato_Hidden"] },
{ name: "100 Coin Shine from Bianco Hills", types: ["Bianco_100s", "Bianco_Early"] },
{ name: "15 Blue Coins from M Graffiti", types: ["M_Graffiti", "Plaza_M", "Ricco_M"] },
{ name: "Defeat Wiggler", types: ["Wiggler", "Gelato_Early"] },
{ name: "15 Blue Coins from Pinna Park", types: ["Pinna_Blues", "Pinna_Early", "Pinna_30"] },
...
{ name: "Collect 1 Hidden Shine in Pinna Park", types: ["Pinna_Early", "Pinna_Hidden", "Pinna_Yoshi"] },
{ name: "Collect 1 Hidden Shine in Noki Bay", types: ["Noki_Early", "Noki_Hidden", "Noki_Rocket"] },
{ name: "Collcet a 100 Coin Shine from a Secret Level", types: ["Secret_100"] },
...
{ name: "20 Blue Coins from Bianco Hills", types: ["Bianco_20", "Bianco_30", "Bianco_Early", "Bianco_Blues"] },
...
{ name: "Defeat Gooper Blooper Returns (Ricco 5)", types: ["Ricco_Top", "Ricco_Early", "Ricco_6", "Ricco_100"] },
...
{ name: "20 Blue Coins from Pinna Park", types: ["Pinna_Blues", "Pinna_Early", "Pinna_30"] },
...
bingoList[9] = [
{ name: "100 Coin Shine from Gelato Beach", types: ["Gelato_100", "Gelato_Early"] },
{ name: "20 Lives", types: ["X_Lives"] },
{ name: "Collect the Sand Bird Shine", types: ["Wiggler", "Gelato_5", "Turbo_Nozzle", "Paint_Race"] },
{ name: "25 Blue Coins in Ricco Harbor", types: ["Ricco_Blues", "Blue_Enemies", "Ricco_Early", "Ricco_30"] },
{ name: "100 Coin Shine from Pinna Park", types: ["Pinna_100", "Pinna_Yoshi", "Pinna_Hoverless"] },
...
bingoList[10] = [
{ name: "Pinna Park Episode 3 Hoverless", types: ["Pinna_Hoverless", "Pinna_Yoshi"] },
...
{ name: "5 Shines from Gelato Beach", types:  ["Gelato_5", "Wiggler", "Gelato_Early"] },
{ name: "7 Blue Coins from Enemies", types: ["Blue_Enemies", "XBoss_Shines", "M_Graffiti"] }
];
bingoList[11] = [
{ name: "Ride Yoshi in Pinna Park", types: ["Pinna_Yoshi", "Pinna_Hoverless", "Butterfly", "Pinna_Early"] },
...
{ name: "8 Shines in Delfino Plaza", types: ["Plaza_Shines", "Plaza_M", "Fruit_Ladies"] },
...
{ name: "9 Shines in Delfino Plaza", types: ["Plaza_Shines", "Plaza_M", "Fruit_Ladies"] },
...
{ name: "Collect 2 Hidden Shines", types: ["Ricco_Hidden", "Ricco_Early"] },
{ name: "Runaway Ferris Wheel from the back Hoverless", types: ["Pinna_Hoverless", "Pinna_Early", "Butterfly"] }
];
bingoList[13] = [
{ name: "2 Piantissimo Races", types: ["Paint_Race", "Wiggler", "Rocket_Nozzle"] },
{ name: "25 Blue Coins from Pinna Park", types: ["Pinna_Blues", "Pinna_Late", "Pinna_30", "Pinna_Yoshi", "Butterfly"] },
{ name: "10 Blue Coins from Sirena Beach", types: ["Sirena_Blues", "Sirena_Early"] },
{ name: "Defeat Shadow Mario in Bianco Hills", types: ["Bianco_Shadow", "Shadow_Mario", "Bianco_Late"] },
{ name: "Defeat Shadow Mario in Ricco Harbor", types: ["Ricco_Shadow", "Shadow_Mario", "Ricco_Late"] },
{ name: "6 Red Coin Shines", types: ["Red_Shines", "Hidden_Shines"] },
{ name: "25 Lives", types: ["X_Lives"] }
];
bingoList[14] = [
{ name: "25 Blue Coins from Gelato Beach", types: ["Gelato_Blues", "Blue_Enemies", "Wiggler", "Gelato_30", "Gelato_Yoshi", "Paint_Race", "Gelato_Early"] },
{ name: "Collect 1 Hidden Shine in Pianta Village", types: ["Pianta_Hidden", "X_Lives"] },
{ name: "Collect 1 Hidden Shine in Sirena Beach", types: ["Sirena_Hidden", "Sirena_Early"] },
{ name: "Collect 2 Hidden Shines in Bianco Hills", types: ["Bianco_Hidden", "Bianco_Late", "Turbo_Nozzle", "Bianco_Yoshi"] },
{ name: "60 Total Blue Coins", types: ["XTotal_Blues", "Blue_30"] },
{ name: "Bianco Hills Episode 8 Shine", types: ["Bianco_Shadow", "Bianco_Late", "Bianco_Yoshi", "Turbo_Nozzle"] }
];
bingoList[15] = [
{ name: "30 Lives", types: ["X_Lives"] },
{ name: "20 Blue Coins from Pianta Village", types: ["Pianta_Blues", "Pianta_Late", "Butterfly", "Pianta_Yoshi", "Pianta_30"] },
{ name: "10 Shines from Delfino Plaza", types: ["Plaza_Shines", "Plaza_M", "Fruit_Ladies"] },
{ name: "8 Linked Blue Coin Pairs", types: ["Linked_Pairs"] },
{ name: "6 Shines from Pinna Park", types: ["Pinna_Boss", "Linked_Pairs", "Pinna_Yoshi", "Butterfly", "Pinna_6", "Pinna_Hoverless"] },
...
bingoList[16] = [
{ name: "5 Secret Shines", types: ["Secret_Shines", "Hidden_Shines", "Bianco_Hidden", "Sirena_Hidden", "Pinna_Hidden"] },
...
{ name: "6 Shines from Pianta Village", types: ["Pianta_Late", "Pianta_8", "X_Lives", "Pianta_6"] },
...
{ name: "Defeat both Cannon Moles", types: ["Noki_Early"] },
...
{ name: "7 Blue Bird Blue Coins", types: ["Linked_Pairs", "Blue_Bird", "Butterfly"] },
{ name: "Defeat Boss of Tricky Ruins (Noki 2)", types: ["Noki_Early"] },
{ name: "20 Blue Coins from Noki Bay", types: ["Noki_Blues", "Noki_Early"] },
{ name: "2 Turbo Nozzle Unlocks", types: ["Gelato_Turbo", "Turbo_Nozzle", "Bianco_Turbo", "Ricco_Turbo"] },
{ name: "Gelato Beach Episode 8 Shine", types: ["Gelato_8", "Gelato_Shadow", "Gelato_5"] },
{ name: "Defeat Shadow Mario in Pinna Park", types: ["Pinna_Shadow", "Shadow_Mario", "Pinna_6"] }
];
bingoList[19] = [
...
{ name: "Pianta Village Episode 8 Shine", types: ["Pianta_8", "Pianta_Shadow", "Pianta_6"] },
...
{ name: "Collect 2 Hidden Shines in Pinna Park", types: ["Pinna_Hidden", "Pinna_Late"] },
{ name: "25 Blue Coins from Pianta Village", types: ["Pianta_Blues", "Pianta_30"] }
];
bingoList[22] = [
{ name: "80 Total Blue Coins", types: ["XTotal_Blues"] },
...
{ name: "Episode 8 of Ricco Harbor", types: ["Ricco_8", "Ricco_Late", "Ricco_Yoshi"] },
{ name: "Collect 2 Hidden Shines in Pianta Village", types: ["Pianta_Late", "Pianta_Hidden", "Pianta_8"] }
];
bingoList[23] = [
{ name: "Episode 8 of Pinna Park", types: ["Pinna_8", "Pinna_Late"] },
...
{ name: "25 Shines", types: ["Total_Shines"] }
];
bingoList[24] = [
...
bingoList[25] = [
{ name: "28 Shines", types: ["Total_Shines"] },
