...
srl.bingo = function (bingoList, size) {
  ...
  results.insertAdjacentHTML("beforeend", "<p>SRL Bingo <strong>v4</strong>&emsp;Seed: <strong>" + SEED + "</strong>&emsp;Card type: <strong>" + cardtype + "</strong></p>");
  ...
  for (i=1; i<=25; i++) {
	document.querySelectorAll("#slot"+i).forEach(cell => cell.innerHTML = bingoBoard[i].name);
  }
